  ...
  return (
    <header className="relative bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none select-none">
        <div className="absolute top-0 left-0 w-32 h-32 bg-white rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
        <div className="absolute top-0 right-0 w-32 h-32 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
        <div className="absolute bottom-0 left-16 w-32 h-32 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-4000"></div>
      </div>
      {/* Navigation */}
      <nav className="relative z-10 container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-7 font-medium">
            ...
            <Link
              href="/guides"
              className="ml-2 px-5 py-2 bg-white text-purple-700 rounded-full font-semibold hover:bg-purple-100 transition-colors duration-200 shadow-sm"
            >
              Get Started
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4">
            <div className="flex flex-col space-y-3 bg-white/10 backdrop-blur-lg rounded-lg p-4 shadow-lg">
              ...
              <Link
                href="/guides"
                className="bg-white text-purple-700 px-6 py-2 rounded-full font-semibold hover:bg-purple-100 transition-colors duration-200 w-full mt-2 text-center"
              >
                Get Started
              </Link>
            </div>
